...
\fbox{\parbox{\textwidth}{
    ...
    \subsubsection*{Evidence before this study}
       Something about how studies showed short term pollution reductions in pollution. Some calculate health risk reductions. Some studies have shown rapid mobility changes in cities. 
    \subsubsection*{Added value of this study}
       Something about how different city types produce different health impacts. We can attribute the things above to city types. Something about how mode shares (in specific types) have changed since CoVID-19 (perhaps permanently realigned).
    \subsubsection*{Implications of all the available evidence}
    Our results show that different city design types can facilitate or constrain policies meant to shift transport mode shares, with additional variations seen across short term stages of a crisis. Addressing these challenges requires knowledge of how specific city types impact policies choices and a nuanced use of these policies across different stages for greatest resilience. CoVID-19 might have permanently realigned transport mode shares towards private vehicle use and represents a backwards step in urban resilience.
}}
...
\begin{itemize}
    ...
    \item[] Global reactions to mitigate CoVID-19 shows that large changes to urban systems are possible, but the rapid rebound to the status quo represents a missed opportunity
\end{itemize}


% I think these are the main points in the paper, to inform the structure and section titles.

%Introduction
%
%City design impacts mobility
%Mobility restrictions due to COVID-19, urban design influenced options
%Cities planned or unplanned, understand impact of design
%Data allows exploration of design
%Health risks can be disproportionate
%Transport infrastructure risk can also be disproportionate
%Interventions can have different results based on city design
%Objective, how city design influences travel, how travel changes change risks, how risks are related to urban design
%City design enables/constrains responses
%
%Methods 
%
%Gathered multiple datasets
%Characterise city design 
%Use graph networks
%City clustered compared to outcomes
%Data of pollution levels
%Data of mobility indexes
%Data of COVID-19 cases
%How to assign risk to new pollution levels
%
%Results
%Mobility and pollution levels across stages of COVID-19
%Reductions and rebounds of pollution levels
%Health risk results from pollution changes
%Shifts in transport modes due to COVID-19
%Pollution level changes due to mode shifts
%City design enables/constrains mode shifts
%Examples of how different city designs impacted mode shifts
%
%Discussion
%Mobility patterns due to city structures
%Different cities had more/less ability and resilience to crisis
%Mobility restrictions reduced pollution health risks
%Risk reductions were short term in most places while others maintained greater resilience
%GHG presents additional risk
%Optimal city types for health vary by crisis and stage
...
\captionsetup{labelformat=empty}
\caption{Box \ref{box:gnn}: Pollution and mobility changes during CoVID-19}\label{box:pollution}
\end{figure}
