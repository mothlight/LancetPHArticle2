...
\caption{\bf t-SNE 2-dimensional representation of 679 global cities, organised by similarities across urban characteristics from OpenStreetMap network graphs. Colour scheme indicates geographic latitude/longitude location\cite{Jackle2017} of each of the cities.}
 \label{fig:tSNE}
\end{figure}
...
\centering
%\fbox{
%\includegraphics[trim={0 895 0 0},clip,scale=0.45]{Images/LA_Drive_trans_BAK.png}
\includegraphics[trim={0 0 0 0},clip,scale=0.5]{Images/LA_Drive_trans_pm25.png}
%}
...
%\includegraphics[trim={0 0 0 0},clip,scale=0.5]{Images/SaoPaulo_Drive_trans_pm25.png}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Images/LA_Drive_trans.png}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Images/SaoPaulo_Drive_trans.png}
     ...
     \begin{subfigure}[b]{0.9\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Images/Tokyo_Drive_trans.png}
         \caption{Tokyo, Japan}
         \label{fig:Tokyo}
     \end{subfigure}
        \caption{\bf An overview of the shift in transportation mode preferences during 2020/21 during the course of the CoVID-19 pandemic for the city of Los Angeles, United States of America Sao Paulo, Brazil and Tokyo, Japan. (Note: I didn't plot pm2.5 reduction in these plots. To show pm2.5 reduction, use Images/XxxXxx\_Drive\_trans\_pm25.png)}
...
\includegraphics[trim={0 0 0 0},clip,scale=0.5]{Images/Tokyo_Drive_trans_pm25.png}
%}
