...
\multicolumn{4}{ |c| }{Calculated Health Risks Due to NO$_{2}$ by Contient and Phase} \\
\hline \hline
...
\hline
\multicolumn{4}{ |c| }{Calculated Health Risks Due to PM$_{2.5}$ (T2 Diabetes) by Contient and Phase} \\
\hline \hline
%Region & Early Phase & Mid Phase & Recovery Phase  \\ \hline
...
\hline
\multicolumn{4}{ |c| }{Calculated Health Risks Due to PM$_{2.5}$ (IHD) by Contient and Phase} \\
\hline \hline
%Region & Early Phase & Mid Phase & Recovery Phase  \\ \hline
...
%}
%\caption{\bf An overview of the shift in transportation mode preferences during 2020/21, highlighting an increased reliance on private vehicle use over public transit during the course of the CoVID-19 pandemic for the city of Los Angeles, United States of America. The red and blue lines show the daily Apple Mobility indexes for driving and transit modes, while the green line shows a 7 day rolling average of PM$_{2.5}$ anomalies.}  
